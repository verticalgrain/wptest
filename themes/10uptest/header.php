...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/favicon-16x16.png">
  <link rel="manifest" href="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/site.webmanifest">
  <link rel="shortcut icon" href="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/favicon.ico">
  <meta name="msapplication-TileColor" content="#da532c">
  <meta name="msapplication-config" content="<?php esc_url( bloginfo( 'template_directory' ) ) ?>/build/images/browserconfig.xml">
...
<body <?php body_class(); ?>>
  ...
  <!-- Using inline styles for loading overlay -->
  ...
  <header class="header">
    ...
    <div class="header__container">
      ...
      <button class="navigation-toggle j-navigation-toggle j-search-close" aria-controls="navigation" aria-label="Navigation toggle" aria-pressed="false">
        <span></span>
        <span></span>
        <span></span>
      </button><!-- .navigation-toggle -->

      <a class="header__hamburger-link" href="<?php echo esc_url( home_url( '/' ) ) ?>" title="Website homepage">
        <span class="header__hamburger-link-text">Eats.</span>
      </a>

      <div class="search">
        <button class="search__toggle j-search-toggle j-navigation-close" aria-controls="search" aria-label="Search toggle" aria-pressed="false">
        </button>
      </div><!-- .search -->
  ...
  <nav class="navigation" id="navigation">
    <?php wp_nav_menu( array( 'theme_location' => 'header-menu', 'items_wrap' => '<ul class="navigation__list">%3$s</ul>' ) ); ?>
  </nav>
